    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{ background: 'linear-gradient(135deg, #0f3d22 0%, #1e6b3f 50%, #2d9b5a 100%)' }}
        >
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-20 right-20 w-72 h-72 bg-white rounded-full blur-3xl" />
            <div className="absolute bottom-10 left-20 w-96 h-96 bg-amber-400 rounded-full blur-3xl" />
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
              استشارتك البيئية
              <br />
              <span className="text-amber-300">في ثوانٍ، لا أيام</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all duration-200 shadow-lg hover:shadow-xl"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={s.step} className="text-center">
                  ...
                  <p className="text-3xl font-bold text-primary-200 mb-2">{s.step}</p>
        ...
        <section className="py-8 bg-amber-50 border-y border-amber-200">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="font-bold text-amber-800 text-sm">تنويه مهم</span>
            </div>
        ...
        <section className="py-20 bg-primary-600">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-white font-bold px-8 py-4 rounded-xl transition-colors"
              >
                إنشاء حساب مجاني
              </Link>
              <Link
